---
title: 'Top 50 Customers: SQL Pseudo Query'
...
-- User data and their app usage data are kept in the tables above. 
...
-- *Bonus for adding in a new column for each user and 
-- flagging their 3rd longest duration with 1 , 
